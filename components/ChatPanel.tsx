      ...
      {isOpen && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              <p style={{ margin: 0, fontWeight: 700, fontSize: "13px", color: "#e5e5e5" }}>Photo Assistant</p>
              <p style={{ margin: 0, fontSize: "11px", color: "#737373" }}>Ask me anything about your D60</p>
            </div>
            {messages.length > 0 && (
              <button
                onClick={() => setMessages([])}
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "14px", display: "flex", flexDirection: "column", gap: "10px" }}>
            {messages.length === 0 && (
              <div style={{ textAlign: "center", padding: "30px 10px" }}>
                <p style={{ color: "#525252", fontSize: "13px", lineHeight: 1.6, margin: 0 }}>
            ...
            {messages.map((m, i) => (
              <div key={i} style={{ display: "flex", justifyContent: m.role === "user" ? "flex-end" : "flex-start" }}>
                <div style={{
                  ...
                  backgroundColor: m.role === "user" ? "#f59e0b" : "#2a2a2a",
            ...
            {isLoading && (
              <div style={{ display: "flex", justifyContent: "flex-start" }}>
                <div style={{ backgroundColor: "#2a2a2a", borderRadius: "14px 14px 14px 4px", padding: "10px 14px", display: "flex", gap: "5px" }}>
                  {[0, 150, 300].map(d => (
                    <span key={d} style={{
          ...
          <div style={{
            ...
            >
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#0d0d0d" strokeWidth="2.5">
