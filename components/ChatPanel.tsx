...
export default function ChatPanel() {
  ...
  return (
    <>
      ...
      >
        {isOpen ? (
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#0a0f0a" strokeWidth="2.5">
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0a0f0a" strokeWidth="2.5">
                <circle cx="12" cy="12" r="3"/>
                <path d="M9 2h6l1.5 3H20a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V6a1 1 0 0 1 1-1h3.5L9 2z"/>
              </svg>
            </div>
            <div style={{ flex: 1 }}>
              <p style={{ margin: 0, fontWeight: 700, fontSize: "13px", color: "#d4d4c8" }}>Photo Assistant</p>
              <p style={{ margin: 0, fontSize: "11px", color: "#4a6b4a" }}>Ask me anything about your D60</p>
            </div>
            {messages.length > 0 && (
              <button
                onClick={() => setMessages([])}
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "14px", display: "flex", flexDirection: "column", gap: "10px" }}>
            {messages.length === 0 && (
              <div style={{ textAlign: "center", padding: "30px 10px" }}>
                <p style={{ color: "#3a5a3a", fontSize: "13px", lineHeight: 1.6, margin: 0 }}>
            ...
            {messages.map((m, i) => (
              <div key={i} style={{ display: "flex", justifyContent: m.role === "user" ? "flex-end" : "flex-start" }}>
                <div style={{
                  ...
                  backgroundColor: m.role === "user" ? "#6ee7b7" : "#1a2a1a",
                  color: m.role === "user" ? "#0a0f0a" : "#d4d4c8",
                  fontSize: "13px",
                  lineHeight: 1.5,
                  whiteSpace: "pre-wrap",
                }}>
            ...
            {isLoading && (
              <div style={{ display: "flex", justifyContent: "flex-start" }}>
                <div style={{ backgroundColor: "#1a2a1a", borderRadius: "14px 14px 14px 4px", padding: "10px 14px", display: "flex", gap: "5px" }}>
                  {[0, 150, 300].map(d => (
                    <span key={d} style={{
          ...
          <div style={{
            ...
            >
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#0a0f0a" strokeWidth="2.5">
