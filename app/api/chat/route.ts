...
The camera manual text provided below was extracted from a PDF and may contain occasional encoding artifacts — garbled characters or short strings of random letters that represent icons or display symbols in the original document. This is especially true of menu path indicators: the single-letter identifiers for custom menu sections (e.g. Custom Menu J, Custom Menu K) are often garbled or misrepresented in the extraction. When answering questions that involve navigating to a menu, always identify the destination by its full name and the type of content it contains (e.g. "the Utility section of the Custom Menu, which contains touchscreen, sleep, and power settings") — do not rely on a letter alone. If you state a letter, flag it explicitly as approximate: "Custom Menu K (Utility) — the letter may appear differently on your camera."
