  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#0e2420", paddingBottom: "100px" }}>
      ...
      <header style={{
        ...
        <div>
          <h1 style={{ color: "#e8f8f2", fontSize: "24px", fontWeight: 700, margin: 0, letterSpacing: "-0.02em" }}>
            Nikon D60 Guide
          </h1>
          <p style={{ color: "#5a9e8e", fontSize: "15px", margin: 0 }}>Interactive Camera Reference</p>
        </div>
      </header>
