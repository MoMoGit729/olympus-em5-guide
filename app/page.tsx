...
export default function Home() {
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#0d0d0d", paddingBottom: "100px" }}>
      ...
      <header style={{
        ...
        <div>
          <h1 style={{ color: "#f5f5f5", fontSize: "16px", fontWeight: 700, margin: 0, letterSpacing: "-0.02em" }}>
            Nikon D60 Guide
          </h1>
          <p style={{ color: "#737373", fontSize: "11px", margin: 0 }}>Interactive Camera Reference</p>
        </div>
      </header>
